          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 sm:py-6 space-y-2 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              <div className="flex flex-wrap gap-2 sm:gap-4">
                <Link href="/inbox" className="text-indigo-600 hover:text-indigo-500 text-sm sm:text-base">
                  Inbox
                </Link>
                <Link href="/leaderboard" className="text-indigo-600 hover:text-indigo-500 text-sm sm:text-base">
                  Leaderboard
                </Link>
              </div>
            ...
            <div className="mt-8">
              ...
              {user.role === 'admin' && (
                <div>
                  <Link
                    href="/admin"
                    className="inline-block bg-red-600 text-white px-6 py-3 rounded-md hover:bg-red-700 w-full sm:w-auto text-center"
                  >
                    Admin Dashboard
                  </Link>
                </div>
